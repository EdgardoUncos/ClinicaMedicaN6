...
namespace ClinicaMedica.Migrations
{
    ...
    [Migration("20250131234050_add-column-Token-Usuarios")]
    partial class addcolumnTokenUsuarios
    {
            ...
            modelBuilder.Entity("ClinicaMedica.Entities.Turnos", b =>
                {
                    ...
                    b.HasOne("ClinicaMedica.Entities.Horarios", null)
                        .WithMany("Turnos")
                    ...
                    b.HasOne("ClinicaMedica.Entities.Medicos", null)
                        .WithMany("Turnos")
                    ...
                    b.HasOne("ClinicaMedica.Entities.Pacientes", null)
                        .WithMany("Turnos")
